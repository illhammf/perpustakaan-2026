...
class FinePolicy
{
    ...
    {
        return $user->can('delete_any_fine');
    }
     ...
     */
    public function replicate(User $user, Fine $fine): bool
    {
