...
class BookCopyPolicy
{
    ...
    {
        return $user->can('view_any_book::copy');
    }
    ...
    {
        return $user->can('view_book::copy');
    }
    ...
    {
        return $user->can('create_book::copy');
    }
    ...
    {
        return $user->can('update_book::copy');
    }
    ...
    {
        return $user->can('delete_book::copy');
    }
    ...
    {
        return $user->can('delete_any_book::copy');
    }
     ...
     */
    public function replicate(User $user, BookCopy $bookCopy): bool
    {
