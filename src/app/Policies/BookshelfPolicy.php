...
class BookshelfPolicy
{
    ...
    {
        return $user->can('view_any_bookshelf');
    }
    ...
    {
        return $user->can('view_bookshelf');
    }
    ...
    {
        return $user->can('create_bookshelf');
    }
    ...
    {
        return $user->can('update_bookshelf');
    }
    ...
    {
        return $user->can('delete_bookshelf');
    }
    ...
    {
        return $user->can('delete_any_bookshelf');
    }
     ...
     */
    public function replicate(User $user, Bookshelf $bookshelf): bool
    {
