...
class ProcurementPolicy
{
    ...
    {
        return $user->can('view_any_procurement');
    }
    ...
    {
        return $user->can('view_procurement');
    }
    ...
    {
        return $user->can('create_procurement');
    }
    ...
    {
        return $user->can('update_procurement');
    }
    ...
    {
        return $user->can('delete_procurement');
    }
    ...
    {
        return $user->can('delete_any_procurement');
    }
