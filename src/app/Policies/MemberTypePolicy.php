...
class MemberTypePolicy
{
    ...
    {
        return $user->can('view_any_member::type');
    }
    ...
    {
        return $user->can('view_member::type');
    }
    ...
    {
        return $user->can('create_member::type');
    }
    ...
    {
        return $user->can('update_member::type');
    }
    ...
    {
        return $user->can('delete_member::type');
    }
    ...
    {
        return $user->can('delete_any_member::type');
    }
